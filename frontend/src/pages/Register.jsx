...
import { Terminal, KeyRound, Mail, User, Shield, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <div class="w-full max-w-md space-y-8 glass-panel p-8 rounded-2xl border border-dark-800 shadow-2xl animate-fade-in">
        ...
        <div class="flex flex-col items-center justify-center text-center space-y-2">
          ...
          <p class="text-xs text-slate-400">
            Join our next-gen competitive programming workspace.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} class="space-y-5">
          <div class="space-y-4">
            ...
            {/* Full Name field */}
            <div class="space-y-1">
              <label for="name" class="text-2xs font-semibold uppercase tracking-wider text-slate-400">
                Full Name
              </label>
            ...
            {/* Role dropdown for easier testing */}
            <div class="space-y-1">
              <label for="role" class="text-2xs font-semibold uppercase tracking-wider text-slate-400">
                Account Role
              </label>
              <div class="relative rounded-lg shadow-sm">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                ...
                <select
                  ...
                  class="block w-full rounded-lg bg-dark-900 border border-dark-800 py-2.5 pl-10 pr-3 text-sm text-slate-300 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-colors cursor-pointer"
                >
                  <option value="User">User (Solve & Submit)</option>
                  <option value="Admin">Admin (CRUD Problems & Manage)</option>
                </select>
              </div>
            </div>
          ...
          >
            {loading ? (
              <>
                <Loader2 class="h-4 w-4 animate-spin" /> Registering...
              </>
            ) : (
              'Create Account'
            )}
        ...
        <div class="text-center text-xs text-slate-400">
          ...
          <Link to="/login" class="font-semibold text-brand-400 hover:underline">
            Sign In here
          </Link>
        </div>
